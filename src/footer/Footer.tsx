...
const Footer = () => {
  return (
    <div className=" box-border flex  h-min max-sm:flex-col items-start justify-around bg-black text-white py-5 md:py-15 lg:py-20">
      ...
      {/**ИНФОРМАЦИЯ */}
      <div className="sm:w-[9rem] xl:w-48 h-auto flex-col mt-0">
        <div className=" w-full max-sm:text-center font-[Droid Sans] font-normal text-sm xl:text-2xl leading-[2.8rem] tracking-widest">
